...
from data_preparation import sign_creator, clear_number, sign_creator_bill,sign_creator_invoice
from database_setup import Base, Log_table

app = Flask(__name__)

# Connect to Database and create database session
engine = create_engine('sqlite:///paymentdb.db', connect_args={'check_same_thread': False})
